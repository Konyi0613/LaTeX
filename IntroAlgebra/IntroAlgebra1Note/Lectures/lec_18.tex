...
\begin{remark}
    In fact, we can generalize integral domains to field of fractions. The prototype is 
    \[
...
\begin{remark}
    We can view every module (in fact abelian group) as a \(\mathbb{Z} \) module since for all \(m \in \mathbb{Z} \) and \(x \in M\) , we can define 
    \[
...
\begin{definition}
    We call \(M^{\prime} \) a sub \(R\)-module if \(M\) is a \(R\)-module and \(M^{\prime} \subseteq M\) forms an \(R\)-module. (Note that for all \(r \in R\)  and \(m \in M^{\prime} \) we have \(r m \in M^{\prime} \))      
\end{definition}
