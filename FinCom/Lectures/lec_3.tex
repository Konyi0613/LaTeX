	...
	\begin{tikzpicture}[font=\footnotesize]
		\begin{groupplot}[
				...
				every axis y label/.style={at={(ticklabel cs:1.0)}, rotate=0,
						anchor=south},
				every axis plot/.append style={MidnightBlue!80!black,
			...
			\nextgroupplot[title={Short a call}, ymin=-42, ymax=0,
				ytick={-40,-30,-20,-10}]
			\addplot coordinates {(0,0) (50,0) (90,-40)};
			...
			\nextgroupplot[title={Short a put}, ymin=-52, ymax=0,
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[font=\footnotesize]
		\begin{groupplot}[
			...
			\nextgroupplot[title={Short a stock}, ymin=-92, ymax=0,
				ytick={-80,-60,-40,-20}]
			\addplot coordinates {(0,0) (90,-90)};
		\end{groupplot}
	\end{tikzpicture}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[font=\footnotesize]
		\begin{axis}[
			...
			\addplot[MidnightBlue!80!black, very thick, domain=81:110,
				samples=140] {bscall(x,90)+bscall(x,100)-2*bscall(x,95)-1.172};
		\end{axis}
	\end{tikzpicture}
