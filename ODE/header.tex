...
%
% Re-checked on TeX Live 2024: still broken.  The trigger is a \color still in
% force at the split point, which every coloured theorem head is (`headfont' in
% the styles below).  `enhanced jigsaw', `colupper=black', `opacityback=0' and
...
\tcbset{
	theorem box/.style={
		enhanced, splitsafe, arc=9pt, outer arc=10pt,
