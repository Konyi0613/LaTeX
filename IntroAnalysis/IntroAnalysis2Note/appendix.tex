...
\begin{problem}
    Let 
    \[
        D = \left\{ (x, y) \in \mathbb{R} ^n, x \ge 0, 0 \le y \le x^2 \right\}, 
    \]
...
\begin{problem}
    ...
    \begin{align*}
        ...
        &= \left\{ A \mid \det (A) \neq 0 \right\},  
    \end{align*}
    which is open in \(\mathbb{R} ^{n + m}\). Consider the inverse map \(g: \mathrm{GL}(n, r) \to \mathrm{GL}(n, r)\), i.e. \(g(A) = A^{-1}\) . Show that \(g^{\prime} (A): \mathbb{R} ^{n \times n} \to \mathrm{R}^{n \times n} \) is \(g^{\prime} (A)(H) = A^{-1} H A^{-1}\) for eveery \(H \in \mathbb{R} ^{n \times n}\). 
