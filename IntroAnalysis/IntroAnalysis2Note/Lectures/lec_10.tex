...
\begin{eg}
    ...
    \[
        m^*(\mathbb{Q} ) \le \sum_{q \in \mathbb{Q} } m^*(\mathbb{Q} ) = 0. 
    \]
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \end{itemize} 
        \item Step 2. Choose one representative from each coset. Let \(\mathbb{R} / \mathbb{Q} \) denote the collection of all cosets. For each coset \(A \in \mathbb{R} / \mathbb{Q} \). By (2) in Step 1, there exists \(x_A \in [0, 1]\) s.t. \(x_A \in A\), and \(A = x_A + \mathbb{Q} \) (By axiom of choice). Define 
        \[
        ...
        \[
            \left\{ q + E : q \in \mathbb{Q} \cap [-1, 1] \right\} 
        \]
        is pairwise disjoint. Suppose, for contradiction, \(q, q^{\prime} \in \mathbb{Q} \cap [-1, 1]\) we had
        \[
            (q + E) \cap (q^{\prime} + E) \neq \varnothing.
        \] 
