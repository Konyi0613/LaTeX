...
\begin{remark}
    We haven't shown that \(\int _\Omega (f + g) = \int _\Omega f + \int _\Omega g\). From definition, it is easy to show \(\int _\Omega (f + g) \ge \int _\Omega f + \int _\Omega g\), but proving equality requires more work and will be done later.  
\end{remark}
