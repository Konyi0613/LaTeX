...
\begin{proof}
    ...
    \]  
    By this, \(\bigcup_{k=1}^{\infty} \Omega _{j_k}\) is measurable since we have shown that the union of countably infinitely many pairwise disjoint measurable sets is measurable. 
...
\begin{proof}
    We say an open box is rational if \(B = \prod _{i=1}^n (a_i, b_i)\) where \(a_i, b_i \in \mathbb{Q} \). The set of rational open boxes is countable (since this set is isomorphic to a subset of \(\mathbb{Q} ^{2n}\)). 
