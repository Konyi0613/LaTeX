...
\begin{lemma} \label{lm: sup, inf, limsup, liminf of measurable func are measurable}
...
\begin{proof}
    ...
    Let $\{f_n\}_{n=1}^\infty$ be a sequence of real-valued functions on a set $\Omega$, and suppose that
\[
f_n(x) \to f(x) \quad \text{for every } x \in \Omega.
\]
We will show that for every $x \in \Omega$,
\[
\limsup_{n\to\infty} f_n(x) = f(x) = \liminf_{n\to\infty} f_n(x).
\]
...
\[
\limsup_{n\to\infty} f_n(x) = \lim_{n\to\infty} \left( \sup_{k \ge n} f_k(x) \right), 
\quad
\liminf_{n\to\infty} f_n(x) = \lim_{n\to\infty} \left( \inf_{k \ge n} f_k(x) \right).
\]
...
Let $\varepsilon > 0$. Since $f_n(x) \to f(x)$, there exists $N \in \mathbb{N}$ such that for all $n \ge N$,
\[
|f_n(x) - f(x)| < \varepsilon,
\]
which implies
\[
f_n(x) \le f(x) + \varepsilon.
\]
Hence, for all $n \ge N$,
\[
\sup_{k \ge n} f_k(x) \le f(x) + \varepsilon.
\]
...
Again let $\varepsilon > 0$. Since $f_n(x) \to f(x)$, there exists $N \in \mathbb{N}$ such that for all $n \ge N$,
\[
|f_n(x) - f(x)| < \varepsilon,
\]
which implies
\[
f_n(x) \ge f(x) - \varepsilon.
\]
Hence, for all $n \ge N$,
\[
\inf_{k \ge n} f_k(x) \ge f(x) - \varepsilon.
\]
Taking the limit as $n \to \infty$, we obtain
\[
...
This shows that if \(f_n \to f\) pointwise, then \(f\) is measurable.  
\end{proof}
...
\begin{eg}
    ...
    \[
        ...
        \end{dcases}
    \]    
    Then, we claim that \(\chi _E\) is measurable. Note that for any open interval \(I\), we have  
    \[
...
\begin{remark}
    This shows \(f\) is simple implies \(f\) is measurable since we can show \(f^{-1} ((a, \infty))\) is measurable for all \(a \in \mathbb{R}\) with knowing that in fact \(f^{-1}((a, \infty))\) is some intersection and union of \(E_i\)'s.      
\end{remark}

\begin{lemma} \label{lm: use simple function approach measurable function}
...
\begin{proof}
    ...
    Now we prove \(\lim_{n \to \infty} f_n(x) = f(x) \). 
    \begin{itemize}
        \item Case 1: \(f(x) = \infty\), then \(f_n(x) = n\), so \(\lim_{n \to \infty} f_n(x) = x \). 
        \item Case 2: \(f(x) < \infty\), then \(\exists N \in \mathbb{N}\) s.t. \(f(x) < N\). If \(n \ge N\), then 
        \[
            f_n(x) = \frac{k}{2^n} \text{ where } \frac{k}{2^n} \le f(x) < \frac{k+1}{2^n}.
        \]        
        Thus, \(f_n(x) \le f(x) \le f_n(x) + \frac{1}{2^n}\), i.e. 
        \[
            \vert f(x) - f_n(x) \vert < \frac{1}{2^n}.
        \] 
