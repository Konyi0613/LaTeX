...
\begin{corollary} \label{cl: measurable func plus, minus, ... is measurable}
...
\begin{definition}[Measurable functions in the extended reals]
    ...
    \]  
    A function \(f: \Omega \to \mathbb{R} ^*\) is said to be measurable if \(f^{-1} ((a, \infty])\) is measurable for all \(a \in \mathbb{R}\), where
    \[
