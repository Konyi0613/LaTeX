...
\begin{theorem}[Contraction Mapping Theorem] \label{thm: Contraction Mapping Theorem}
...
\begin{lemma} \label{lm: first lemma for inverse function theorem}
...
\begin{proof}
    ...
    \begin{explanation}
        ...
        \[
            \lVert F(x_1) - F(x_2) \rVert = \lVert g(x_1) - g(x_2) \rVert \le \frac{1}{2} \lVert x_1 - x_2 \rVert.   
        \] 
        Thus, \(F\) is a strict contraction. 
    \end{explanation} 
    Now since closed ball is non-empty and complete, so by \autoref{thm: Contraction Mapping Theorem}, \(F\) has a fixed point. 
\end{proof}