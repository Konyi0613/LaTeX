...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \]   
        \item Step 2: Extend uniform continuity to all of \(\mathbb{R} \). Let \(\varepsilon > 0\) to be fixed and choose \(\delta\) as above. Take any \(x, y \in \mathbb{R} \). We must show that 
        \[
