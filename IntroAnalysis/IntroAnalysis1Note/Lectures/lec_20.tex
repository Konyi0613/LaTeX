...
\begin{theorem}[Logarithm properties] \label{thm: logarithm properties}
    ...
    \begin{itemize}
        \item [(a)] For \(x \in (0, \infty )\), we have \(\frac{\mathrm{d}}{\mathrm{d}x} \ln x = \frac{1}{x} \). Hence, \(\int _a^b \ln x \, \mathrm{d} x = \ln b - \ln a \) when \([a, b] \subseteq (0, \infty )\). 
...
\begin{proof}[proof of (d)]
    Note that 
    \begin{align*}
        &\exp \left( y \ln (x) \right) = ^{y \ln x} = \left( e^{\ln x} \right)^y = x^y. \\
