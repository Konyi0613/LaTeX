...
\begin{eg}
    ...
    \[
        ...
        \end{dcases} 
    \]
    Now by Parseval's identity: \(f \in C(\mathbb{R} / \mathbb{Z} , \mathbb{C} )\), then
    \[
        \lVert f \rVert_2^2 = \sum_{n = -\infty }^{\infty } \left\vert \hat{f} (n) \right\vert^2.   
    \]
    We know 
    \[
        \frac{1}{12} = \frac{1}{16} + 0 + 2 \sum_{m = 0}^{\infty} \frac{1}{(2m + 1)^4 \pi ^4}, 
    \]
    so we have 
    \[
        \frac{\pi ^4}{96} = \sum_{m = 0}^{\infty} \frac{1}{(2m + 1)^4}. 
    \]
    Also, we have 
    \[
        \sum_{n \in \mathbb{Z} } \left\vert \hat{f} (n) \right\vert  
    \]
    convergse, so
    \[
        f(x) = \sum_{n \in \mathbb{Z} } \hat{f} (n) e_n(x) \implies f(x) = \frac{1}{4} + 2\sum_{m=0}^{\infty } \frac{1}{(2m + 1)^2 \pi ^2} e^{2 \pi i (2m + 1) x}. 
    \]
    and thus 
    \[
        \left\vert x - \frac{1}{2} \right\vert = f(x) = \frac{1}{4} + 2\sum_{m=0}^{\infty } \frac{1}{(2m + 1)^2 \pi ^2} e^{2 \pi i (2m + 1) x}. 
    \]
    Now if we pick \(x = 0\), then 
    \[
        \frac{1}{2} = \frac{1}{4} + 2 \sum_{m=0}^{\infty } \frac{1}{(2m + 1)^2 \pi ^2} \implies \frac{\pi ^2}{8} = \sum_{m = 0}^{\infty } \frac{1}{(2m + 1)^2}.  
    \] 
\end{eg}