...
\begin{definition}
    Let \(\varepsilon > 0\) and \(0 < \delta < \frac{1}{2}\). A function \(f \in C(\mathbb{R} / \mathbb{Z} , \mathbb{C} )\) is a periodic \((\varepsilon , \delta )\) approximation to the identity if the following two conditions holds:
    \begin{itemize}
...
\begin{proof}
    ...
    \begin{claim}
        ...
        \] 
        and we can pick \(P\) to be this \(F_N(x)\) with enough large \(N\).  
    \end{claim}
    ...
    Now we already know \(F_N(x) \ge 0\) and \(\int _0^1 F_N(x) \, \mathrm{d} x = 1\), and we know \(F_N(x)\) is a trigonometric polynomial, so \(F_N(x) \in C(\mathbb{R} / \mathbb{Z} , \mathbb{C} )\).   
...
\begin{proof}
    ...
    \begin{align*}
        ...
        &\le \int _0^1 \left\vert f(x) - f(x - y) \right\vert P(y) \, \mathrm{d} y    
    \end{align*}
    ...
    \begin{align*}
        ...
        \int _{1 - \delta }^1 \left\vert f(x) - f(x - y) \right\vert P(y) \, \mathrm{d} y &\le \int_{1 - \delta }^1 P(y) \, \mathrm{d} y \le \frac{\varepsilon}{4}.
    \end{align*} 
    On \([\delta , 1 - \delta ]\), we use \(\left\vert f(x) - f(x - y) \right\vert \le 2M \) and \(P(y) < \frac{\varepsilon}{4}\), so 
    \[
    ...
    \]
    and we can pick \(G = f * P\), which is a trigonometric polynomial, so that 
    \[
