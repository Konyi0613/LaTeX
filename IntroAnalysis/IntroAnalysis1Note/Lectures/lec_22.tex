...
Given any periodic, continuous function. It can be approximated by Trigonometric functions uniformly.
...
\begin{definition}
    ...
    \[
        C \left( \mathbb{R} /\mathbb{Z}, \mathbb{C}   \right) = \left\{ f \mid f:\mathbb{R} \to \mathbb{C} , f\text{ is continuous}, f(x+1)=f(x)  \right\}.  
    \]   
\end{definition}
...
\begin{lemma}
    ...
    \begin{itemize}
        ...
        \item [(c)] If \(\left\{ f_n \right\}_{n=1}^{\infty}  \) with \(f_n \in C \left( \mathbb{R} / \mathbb{Z} , \mathbb{C}  \right) \) and \(\lim_{n \to \infty} d_\infty (f_n, f) = 0\), then \(f \in C \left( \mathbb{R} / \mathbb{Z} , \mathbb{C}  \right) \). This implieas that \((C (\mathbb{R} / \mathbb{Z} , \mathbb{C} ), d_\infty )\) is a complete metric space.
    \end{itemize} 
\end{lemma}
\begin{proof}[proof of (a)]
    ...
    \] and \(f^1\) is continuous and \([0, 1]\), so there exists \(M_1\) s.t. \(\left\vert f^1(x) \right\vert \le M_1 \). Similarly, we can show thaere exists \(M_2\) s.t. \(\left\vert f^2(x) \right\vert \le M_2\) and thus 
    \[
...
\begin{proof}[proof of (c)]
    ...
    \end{align*} 
    This means \(f(x+1) = f(x)\) since \(\vert f(x+1) - f(x) \vert \) can be arbitrarily small.  
\end{proof}
...
\begin{definition}
    ...
    \] and if we suppose \(f = f^1 + i f_2\) and \(g = g^1 + i g_2\) for \(f^1, f^2, g^1, g^2 \in C(\mathbb{R} / \mathbb{Z} , \mathbb{R} )\), then 
    \[
...
\begin{lemma}
    ...
    \begin{itemize}
        ...
        \item [(3)] \(\langle f + g, h \rangle = \langle f, h \rangle + \langle g, h \rangle   \). 
...
\begin{lemma}
    ...
    \begin{itemize}
        \item [(a)] \(\lVert f \rVert_2 = 0 \) iff \(f = 0\), where \(\lVert f \rVert_2 = \left( \langle f, f \rangle  \right)^{\frac{1}{2}}  \).   
        ...
        \item [(d)] If \(\langle f, g \rangle = 0 \), then \(\lVert f+g \rVert_2^2 = \lVert f \rVert _2^2  \) 
