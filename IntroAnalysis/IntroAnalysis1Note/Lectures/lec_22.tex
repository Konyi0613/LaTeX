...
\begin{proof}[proof of (b)]
    ...
    \begin{align*}
        \left\vert \int _0^1 f(x) \overline{g}(x)  \right\vert \, \mathrm{d} x &\le \int _0^1 \left\vert f(x) \overline{g}(x)  \right\vert = \int _0^1 \vert f(x) \vert \left\vert \overline{g}(x)  \right\vert \, \mathrm{d} x \\
