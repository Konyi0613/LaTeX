...
Last time, we show that the sequence \(\left\{ x_n \right\}_{n=1}^{\infty}  \) with \(x_n = n\) converges to any point in \(\mathbb{R} \) in cofinite topology i.e. 
\[
...
\begin{proposition} \label{prop: conti TFAE again}
