...
\begin{problem}[Hamiltonian Cycle]
    ...
    \begin{itemize}
        ...
        \item Output: Whether or not \(G\) contains a simple cycle that contains all vertices of \(G\).   
    \end{itemize}
\end{problem}
...
\begin{problem}[Hamiltonian Path]
    \vphantom{text}
    \begin{itemize}
        \item Input: An undirected graph \(G\) and two vertices \(s, t\) of \(G\). 
        \item Output: Whether or not \(G\) contains a simple \(st\)-path that contains all vertices of \(G\).   
    \end{itemize}
\end{problem}
