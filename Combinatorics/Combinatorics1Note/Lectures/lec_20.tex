...
\begin{answer}
    ...
    \begin{itemize}
        ...
        Then
        \[
            \vert A \vert = \binom{n-1}{\frac{n+1}{2}} + \binom{n-1}{\frac{n-3}{2}} < \binom{n}{\frac{n+1}{2}} = \binom{n-1}{\frac{n+1}{2}} + \binom{n-1}{\frac{n-1}{2}}. 
        \]
    \end{itemize}
\end{answer}

\begin{theorem}[Sperner 1928]
    The size of the largest antichain in \(\left( 2^{[n]}, \subseteq  \right) \) is \(\binom{n}{\left\lfloor \frac{n}{2} \right\rfloor}\).  
\end{theorem}