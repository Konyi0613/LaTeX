...
\begin{prev}
\[
    e \left( \frac{n}{e} \right)^n \le n! \le (n+1) \left( \frac{n}{e} \right)^n, \quad n! \thickapprox \sqrt{2\pi n}\left( \frac{n}{e} \right)^n \text{[Stirling]}.     
\]
Also, 
\[
...
\[
    p(n) \le \frac{\left( \prod_{j=1}^{\infty} \frac{1}{1-x^j} \right) }{x^n},
\] and thus 
\begin{align*}
...
\] so \(k \thickapprox \sqrt{n} \), and thus we can set \(k = \left\lfloor \sqrt{n}  \right\rfloor\). Hence, 
\begin{align*}
