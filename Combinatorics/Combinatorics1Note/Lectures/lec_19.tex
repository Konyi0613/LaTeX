...
\end{theorem}
\begin{proof}
    Since \(A = A \cupdot (B \setminus A)\) and \(B = (B \setminus A) \cupdot (A \cap B)\). Hence, by sum rule, we have 
    \[
...
\] which means 
\begin{align*}
   \left\vert \bigcup_{i=1}^n A_i  \right\vert &= \vert S \vert - \left( \sum_{I \in [n]} (-1)^{\vert I \vert } \left\vert \bigcap_{i \in I} A_i  \right\vert  \right) = \vert S \vert - \left( (-1)^{\vert \varnothing  \vert } \left\vert \bigcap_{i \in \varnothing } A_i  \right\vert + \sum_{\substack{I \subseteq [n] \\ I \neq \varnothing }} (-1)^{\vert I \vert } \left\vert \bigcap_{i \in I} A_i  \right\vert    \right) \\
...
\begin{explanation}
    ...
    \[
        A_i = \left\{ \# \text{ method s.t. student } \# i \text{ gets own exam}   \right\} = \left\{ \pi : \pi (i) = i \right\}.  
    \]
...
\[
    \mathbb{P} \left( \pi \text{ is an derrangement}  \right) = \frac{\left\vert S_n \setminus  \left( \bigcup_{i=1}^{n} A_i  \right)  \right\vert }{n!} = \frac{1}{n!} \sum_{I \subseteq [n]} (-1)^{\vert I \vert } \left\vert \bigcap_{i=1}^{n} A_i  \right\vert = \frac{1}{n!} \sum_{k=0}^n \binom{n}{k} (-1)^k (n-k)! = \sum_{k=0}^n \frac{(-1)^k}{k!}.    
\] 
Hence, 
\[
