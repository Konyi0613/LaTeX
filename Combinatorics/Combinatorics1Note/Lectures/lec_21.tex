...
\begin{definition}
    Let \((P, \subseteq )\) be a finite poset. A chain partition/decomposition of \(P\) is a partition of \(P\) into disjoint chains 
    \[
...
\begin{theorem}
    Let \((P, \subseteq )\) be a finite poset, then 
    \begin{align*}
        \left\vert \text{Largest chain} \right\vert  &= \left\vert \text{Smallest antichain partition} \right\vert . \\
        \left\vert \text{Largest antichain}  \right\vert &= \left\vert \text{Smallest chain partition} \right\vert . 
    \end{align*} 
\end{theorem}
\begin{proof}
