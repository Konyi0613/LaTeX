...
\begin{explanation}
    If a man has been rejected by everyone, then it implies every woman has been proposed to, and thus every woman has \(n\) distinct "maybe" partner, but there are only \(n\) men, so it is impossible.  
\end{explanation}