...
\begin{proof}[proof of Dirac's theorem]
    ...
    \hfill
        \begin{itemize}
            ...
            \]  
            Such an \(i\) must exist: let \(S = \left\{ v_i : \left\{ u, v_{i+1} \right\} \in E  \right\} \), then \(\vert S \vert = \vert N(u) \vert = \deg(u) \ge \frac{n}{2} \). Also, \(\vert N(v) \vert = \deg(v) \ge \frac{n}{2} \) and \(N(u) \cup N(v) \subseteq V(P)\). Note that 
            \[
