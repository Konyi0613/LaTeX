...
\begin{lemma}[Conservation]
    For any source-sink cut \(\left[ Q, \overline{Q} \right] \), 
    \[
...
\begin{proof}
    We can do induction on \(\vert Q \vert \). 
    \begin{itemize}
        ...
        \begin{align*}
            ...
            &= \sum_{\substack{\vv{e} \in \left[ Q, \overline{Q} \right] \\ x \neq e^+ }} - \sum_{\substack{\vv{e} \in \left[ \overline{Q}, Q \right] \\ x \neq e^- }} + \sum_{\vv{e} \in \left[ x, \overline{R} \right] } f(\vv{e}) - \sum_{\vv{e} \in \left[ \overline{R} , x \right] } f(\vv{e}) \\
            &= \sum_{\vv{e} \in \left[ Q, \overline{Q} \right] } f(\vv{e}) - \sum_{\vv{e} \in [Q, x]} f(\vv{e}) - \sum_{\vv{e} \in [\overline{Q} , Q]} f(\vv{e}) + \sum_{\vv{e} \in [x, Q]} f(\vv{e}) + \sum_{\vv{e} \in [x, \overline{R}]} f(e) - \sum_{\vv{e} \in \left[ \overline{R} , x \right] } f(\vv{e}) \\
