...
\begin{remark}
    The other direction of Global edge Menger is trivially true.
\end{remark}
...
\begin{definition}
    ...
    \begin{itemize}
        \item \(\vec{D} = (V, E)\) is a directed multigraph s.t. \(V\) is a set of vertices and \(E \subseteq V^2\) is a multiset of directed edges: \(e = (e^-, e^+)\).
...
\begin{definition}
    ...
    \]
    where \(S \subseteq V, \overline{S} = V \setminus S, s \in S, t \in \overline{S}\). The capacity of the cut is 
    \[
