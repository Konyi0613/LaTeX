...
\section{Configuration in Lua}\label{sec:nvim-lua}
...
\section{Mappings and Autocommands}\label{sec:nvim-keymaps}
...
\section{Talking to Vim from Lua}\label{sec:nvim-api}
...
\section{The Built-in Terminal}\label{sec:nvim-terminal}
...
\section{Treesitter}\label{sec:nvim-treesitter}
...
\section{LSP: Language Servers}\label{sec:nvim-lsp}
...
\section{Completion and Snippets}\label{sec:nvim-cmp}
...
\autoref{ch:vim-setup} shows this configuration as it actually stands on this
machine.

\section{Plugins and \texttt{lazy.nvim}}\label{sec:nvim-plugins}
