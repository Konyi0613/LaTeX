\chapter{The Setup on This Machine}\label{ch:setup}
...
\subsection{Keys worth knowing first}
...
\section{VimTeX}\label{sec:vimtex}
...
\section{The \texorpdfstring{\LaTeX{}}{LaTeX} Workflow, End to End}
