\chapter{Editing in Practice}\label{ch:editing}

\section{Entering Insert Mode}\label{sec:insert-entry}
...
\begin{keys}[0.16]
	...
	\key{<C-h>}   & Backspace                                           \\
	\key{<C-r>} \texttt{\{reg\}} & Insert the contents of a register (\autoref{sec:registers}) \\
...
\begin{moral}
	...
	(\autoref{sec:global}) when the change is described by a pattern rather than a
	position.
\end{moral}
...
\section{The Global Command}\label{sec:global}
