...
\begin{explanation}
    \begin{align*}
        \mathbb{P} (Z \le z) &= \mathbb{P} \left( \frac{X - \mu}{\sigma} \le z \right) = \mathbb{P} (X \le \mu + 2 \sigma) = \int _{-\infty }^{\mu + 2 \sigma} \frac{1}{\sigma \sqrt{2 \pi} } e^{-\frac{(x - \mu )^2}{2 \sigma ^2}} \, \mathrm{d} x.  
    \end{align*}
    Now we change the variable, let \(t = \frac{x - \mu}{\sigma}\), i.e. \(x = \mu + t \sigma \), then we have 
    \[
        \mathbb{P} (Z \le z) = \int _{-\infty }^{\mu + 2 \sigma} \frac{1}{\sigma \sqrt{2 \pi} } e^{-\frac{(x - \mu )^2}{2 \sigma ^2}} \, \mathrm{d} x = \int _{-\infty }^z \frac{1}{\sqrt{2 \pi } } e^{-\frac{t^2}{2}} \, \mathrm{d} t = \mathbb{P} (N(0, 1) \le z).  
    \]  
\end{explanation}
...
Thus, for \(X \sim N(\mu , \sigma ^2)\), we have \(Z = \frac{X - \mu}{\sigma }\), i.e. \(2 \sigma + \mu = X\). Hence,
\[
...
\begin{explanation}
    ...
    \begin{itemize}
        \item Case 1: \(z < x\), always keep envelop, we have \(50 \%\) of winning. 
        \item Case 2: \(x < z < 2x\), always get right right envelop, so we have \(100 \%\) of winning.  
    ...
    \begin{align*}
        ...
        &= 50\% + 50 \% \cdot \mathbb{P} (x < z < 2x) > 50 \%.
    \end{align*}
\end{explanation}

Recall that if \(X \sim N(\mu , \sigma ^2)\), \(f_X(x) = \frac{1}{\sigma \sqrt{2 \pi } } e^{- \frac{(x - \mu )^2}{2 \sigma ^2}}\), then if we let \(Z = \frac{X - \mu}{\sigma }\), then \(Z \sim N(0, 1)\), and we call \(Z\) to be the z-score. 
...
\begin{remark}
    ...
    \begin{itemize}
        ...
        \item [(iii)] By symmetry of this distribution, \(\mathbb{P} (Z \le z) = \mathbb{P} (Z \ge -z) = 1 - \mathbb{P} (Z \le -z) = 1 - \Phi (-z)\).   
    \end{itemize}
\end{remark}