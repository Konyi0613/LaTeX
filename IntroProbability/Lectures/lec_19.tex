...
\begin{answer}
    ...
    \begin{itemize}
        ...
        \[
            f_{S_3}(z) = \int _0^z f_{S_2}(x) \overbrace{f_{X_3}(z - x)}^1 \, \mathrm{d} x = \int _0^z x \, \mathrm{d} x = \frac{z^2}{2}.  
        \]
        \begin{claim}
        ...
        \begin{explanation}
            ...
            \begin{align*}
                f_{S_{n+1}}(z) &= \int _0^z f_{S_n}(x) \overbrace{f_{X_{n+1}}(z - x)}^1 \, \mathrm{d} x = \int _0^z f_{S_n}(x) \, \mathrm{d} x = \int _0^z \frac{x^{n-1}}{(n-1)!} \, \mathrm{d} x = \frac{z^n}{n!}.   
            \end{align*}  
        \end{explanation}
    \end{itemize} 
