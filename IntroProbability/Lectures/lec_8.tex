...
\begin{explanation}
    ...
    In fact,
    \begin{align*}
        p_{67} &= \mathbb{P} (\text{happy} \mid \text{start at } 67 \text{ and win first round}) \mathbb{P} (\text{win first round } \mid \text{start at } 67) \\ &+ \mathbb{P} (\text{happy} \mid \text{start at } 67 \text{ and lose first round}) \mathbb{P} (\text{lose first round } \mid \text{start at } 67) 
    \end{align*}
