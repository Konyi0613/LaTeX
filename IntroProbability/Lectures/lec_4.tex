...
\begin{theorem}
    ...
    \[
        \mathbb{P} \left( \bigcup_{i=1}^{n} E_i  \right) = \sum_{i=1}^n (-1)^{r+1} \sum_{1 \le i_1 < i_2 < \dots < i_r \le n} \mathbb{P} (E_1 \cap E_2 \cap \dots \cap E_r) = \sum_{I \subseteq [n] \setminus \varnothing } (-1)^{\vert I \vert + 1 } \mathbb{P} \left( \bigcap_{i \in I} E_i  \right) .   
    \]  
\end{theorem}
