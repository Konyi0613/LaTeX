...
\begin{proof}
    ...
    \begin{align*}
       &\quad \iint_{\left\{ \substack{(x_1, x_2): g_1 \le y_1, g_2 \le y_2} \right\} } f_{X_1, X_2} (x_1, x_2) \, \mathrm{d} x_1 \, \mathrm{d} x_2 \\
       &= \iint_{\left\{ u_1 \le y_1, u_2 \le y_2 \right\} } f_{X_1, X_2} \left( x_1(u_1, u_2), x_2(u_1, u_2) \right) \left\vert J(x_1(u_1, u_2), x_2(u_1, u_2)) \right\vert^{-1} \, \mathrm{d} u_1 \, \mathrm{d} u_2.     
    \end{align*} 
...
\begin{eg}
    ...
    and 
    \[
        \left\vert \det J(x_1, x_2) \right\vert  = \left\vert \det \begin{pmatrix}
            1 & 1  \\
            1 & -1  \\
        \end{pmatrix} \right\vert = \vert -2 \vert  \neq 0, 
    \]
    so 
    \[
