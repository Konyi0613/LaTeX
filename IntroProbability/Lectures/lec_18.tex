...
\begin{explanation}
    ...
    \]    
    and by \(\int _{-\infty }^{\infty} f_X(x) \, \mathrm{d} x  = 1\), we have \(A = \frac{1}{\sigma \sqrt{2 \pi} }\). Hence, \(X \sim N(0, \sigma ^2)\). By symmetry, we know \(Y \sim N(0, \overline{\sigma} ^2)\). Hence, 
    \[
