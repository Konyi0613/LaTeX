...
\begin{align*}
    ...
    &\thickapprox \frac{f_{X, Y}(x,y) \delta _x \delta _y}{f_Y(y) \delta _y} \quad \text{ as } \delta _x, \delta _y \to 0  \\
...
\begin{eg}
    Now we take a coin whose probability of heads is unknown, i.e. \(\mathbb{P} (\text{head}) = P \sim \mathrm{Unif}([0, 1]) \). We toss the coin \(n\) times and observe \(k\) heads. Given this information, what can we say about the distribution of \(P\)?   
\end{eg}
