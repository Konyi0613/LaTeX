...
\begin{eg}
    ...
    Hence, 
    \[
        \mathbb{P} \left( \bigcup_{i=1}^n E_i  \right) = 1 - \mathbb{P} \left( \left( \bigcap_{i=1}^{n} E_i  \right)^C  \right) = 1 - \prod _{i=1}^n \mathbb{P} (E_i^C) = 1 - \prod _{i=1}^n (1 - \mathbb{P} (E_i)).  
    \] 
\end{eg}