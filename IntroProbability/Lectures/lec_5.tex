...
\begin{proof}
    ...
    \begin{itemize}
        ...
        If \(t\) is odd, then 
        \begin{align*}
            \mathbb{P} \left( \bigcup_{j < i} (E_i \cap E_j)  \right) &\le \sum_{r=1}^t (-1)^{r+1} \sum_{1 \le j_1 < j_2 < \dots < j_r < i} \mathbb{P} \left( \bigcap_{k=1}^{r} (E_{i} \cap E_{j_{k} })  \right) \\
...
\begin{eg}
    ...
    \begin{align*}
        \mathbb{P} \left( \bigcup_{i=1}^{n} E_i  \right) &\ge \sum_{i=1}^n \mathbb{P} (E_i) - \sum_{1 \le i < j \le n} \mathbb{P} (E_i \cap E_j) = \sum_{i=1}^n \frac{1}{n} - \sum_{1 \le i < j \le n}\frac{1}{n(n-1)} \\
...
\begin{proof}
    \begin{align*}
        0 \le \mathbb{P} \left( \limsup_{n \to \infty} E_n  \right) &= \mathbb{P} \left( \lim_{n \to \infty} \bigcup_{i=n}^{\infty} E_i   \right) = \lim_{n \to \infty} \mathbb{P} \left( \bigcup_{i=n}^{\infty} E_i  \right) \le \lim_{n \to \infty} \sum_{i=n}^{\infty} \mathbb{P} (E_i) = 0      
    \end{align*}
