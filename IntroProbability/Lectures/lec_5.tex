...
\begin{theorem}[Bonferroni]
    ...
    \[
        ...
        \left\{ \begin{array}{c}
             ...
             \textcolor{red}{\ge} \\
        \end{array} \right\} 
        \sum_{i=1}^t (-1)^{r+1} \sum_{1 \le i_1 < i_2 < \dots < i_r \le n} \mathbb{P} (E_{i_1} \cap E_{i_2} \cap \dots \cap E_{i_r}) \text{ if } t \text{ is } \begin{dcases}
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        If \(t\) is odd, then 
        \begin{align*}
            \mathbb{P} \left( \bigcup_{j < i} (E_i \cap E_j)  \right) &\le \sum_{r=1}^t (-1)^{r+1} \sum_{j_1 < j_2 < \dots < j_r < i} \mathbb{P} \left( \bigcap_{i=1}^{r} (E_{i} \cap E_{j_{r} })  \right) \\
            &= \sum_{i=1}^t (-1)^{r + 1} \mathbb{P} (E_{j_1} \cap E_{j_2} \cap \dots \cap E_{j_r} \cap E_i).     
        \end{align*} 
        Thus, 
        \begin{align*}
        ...
        \begin{align*}
            ...
            &= \sum_{i=1}^t (-1)^{r + 1} \sum_{1 \le i_1 < \dots < i_r \le n} \mathbb{P} (E_{i_1} \cap E_{i_2} \cap \dots \cap E_{i_r}).         
        \end{align*}
    \end{itemize} 
...
\begin{proof}
    ...
    Thus, 
    \[
        \lim_{n \to \infty} \mathbb{P} \left( E_n^C \right) = \mathbb{P} \left( \lim_{n \to \infty} E_n^C  \right) = \mathbb{P} \left( \bigcup_{i=1}^{n} E_n^C  \right) = \mathbb{P} \left( \left( \bigcap_{n=1}^{\infty} E_n \right)^C   \right) = 1 - \mathbb{P} \left( \bigcap_{n=1}^{\infty} E_n  \right).      
    \]
    Also, 
    \[
...
\begin{remark}
    \(\limsup_{n \to \infty} E_n \) means infinitely many of the events \(E_n\) occurs, while \(\liminf_{n \to \infty} E_n \) means only finitely many of the events do not occur.
\end{remark}
