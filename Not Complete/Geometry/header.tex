...
% CJK fonts: prefer Noto CJK TC, fall back to fonts shipped with macOS,
% and skip the CJK setup entirely if neither is installed.
\newif\ifCJKfonts
\IfFontExistsTF{Noto Serif CJK TC}{%
  \CJKfontstrue
  \def\cjkserif{Noto Serif CJK TC}\def\cjkserifbold{Noto Serif CJK TC Bold}%
  \def\cjksans{Noto Sans CJK TC}\def\cjksansbold{Noto Sans CJK TC Bold}%
  \def\cjkmono{Noto Sans Mono CJK TC}%
}{%
  \IfFontExistsTF{Songti TC}{%
    \CJKfontstrue
    \def\cjkserif{Songti TC}\def\cjkserifbold{Songti TC Bold}%
    \def\cjksans{Heiti TC}\def\cjksansbold{Heiti TC Medium}%
    \def\cjkmono{Heiti TC}%
  }{\CJKfontsfalse}%
}
\ifCJKfonts
  \ifXeTeX
    \usepackage{xeCJK}
    \setCJKmainfont{\cjkserif}[BoldFont=\cjkserifbold]
    \setCJKsansfont{\cjksans}[BoldFont=\cjksansbold]
    \setCJKmonofont{\cjkmono}
  \else
    \usepackage{luatexja-fontspec}
    \setmainjfont{\cjkserif}[BoldFont=\cjkserifbold]
    \setsansjfont{\cjksans}[BoldFont=\cjksansbold]
    \setmonojfont{\cjkmono}
  \fi
\fi

% Latin Modern Sans is not installed as a system font; load the OTF files
% that ship with TeX Live instead.
